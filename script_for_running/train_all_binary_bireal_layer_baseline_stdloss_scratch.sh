...
do
    ...
    --learning_rate=${lr} | tee -a ./Vcvpr_abalation_onvar_sketch_resnet18_binary_noinit_${opt_type}_w_${wd}_seed${s}_${data}_target_${target}_varw_rate${varw[k]}_lr${lr}_type${nettype}.txt&&
    echo "done $target" &
