...
def get_args():
    ...
    parser.add_argument("--network", choices=['resnet18', 'resnet50', 'resnet18_gananstyleV1', 'resnet18_gananstyleV2', 'resnet18_binary'], help="Which network to use", default="resnet18")
    ...
    parser.add_argument("--no_flag", default=False, action='store_true', help="Use RSC")
    ...
    parser.add_argument("--var_type", default='last', choices=['all', 'last'], type=str, help="")
...
class Trainer:
    def __init__(self, args, device):
        ...
        if args.network == 'resnet18':
            ...
            model = birealnet18(pretrained=True, classes=args.n_classes, cal_var_loss=args.cal_var_loss, var_type=args.var_type)
    ...
    def do_test(self, loader):
        ...
        final_out = {"class_correct": class_correct}
        if self.args.cal_var_loss:
